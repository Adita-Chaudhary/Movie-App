      ...
      >
        <div className="relative aspect-[2/3] w-full bg-panel-raised">
          ...
          {typeof movie.vote_average === 'number' && movie.vote_average > 0 && (
            <span className="absolute left-2 top-2 rounded bg-black/75 px-2 py-0.5 text-xs font-semibold text-gold">
        ...
        <div className="flex flex-1 flex-col gap-1 p-3 sm:p-4">
          <h3 className="line-clamp-2 text-sm font-normal sm:text-base">{movie.title}</h3>
